...
# Touchscreen already inherits from Component — listing both bases would
# cause register_touchscreen() to fail with 'registered twice'.
FT3168Touchscreen = ft3168_ns.class_(
    "FT3168Touchscreen", touchscreen.Touchscreen
)
...
async def to_code(config):
    ...
    # register_touchscreen registers the Component for us — calling
    # register_component separately would double-register.
